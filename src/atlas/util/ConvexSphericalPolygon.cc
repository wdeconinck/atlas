...
int ConvexSphericalPolygon::nextIntersect( int control, std::vector<PointXYZ>& iplg_p, const ConvexSphericalPolygon& plg, const int ii0, const int jj0, const int inside ) const {
