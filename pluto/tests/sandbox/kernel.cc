...
HIC_DEVICE pluto::device::memory_resource* gpu_default_;

// __global__ void set_default_global(pluto::device::memory_resource* ptr) {
//     gpu_default_= DevicePtr<pluto::device::memory_resource>::FromRawDevicePtr(ptr);
// }

HIC_DEVICE void set_device_ptr(pluto::device::memory_resource*& destination, pluto::device::memory_resource* source) {
    destination = source;
}

#if HIC_COMPILER
__global__ void launch_set_default(pluto::device::memory_resource* ptr) {
...
void set_default_on_device(pluto::device::memory_resource* ptr) {
#if HIC_COMPILER
...
void set_on_device(double* x, std::size_t size, double value) {
    ...
    // using memory_resource = pluto::device::memory_resource;
